          ...
          <style>
            * {{
            ...
            .vetted-badge {{
              ...
              margin-bottom: 14px;
              border-radius: 18px;
              background: linear-gradient(135deg, rgba(28,10,8,0.96) 0%, rgba(70,10,8,0.96) 48%, rgba(22,10,10,0.98) 100%);
              border: 1px solid rgba(212,175,55,0.45);
              box-shadow: 0 0 0 1px rgba(255,255,255,0.04) inset, 0 0 22px rgba(204,0,0,0.18);
              color: #f7df8a;
            ...
            .vetted-badge::before {{
              ...
              position: absolute;
              inset: 0;
              background: linear-gradient(90deg, rgba(255,140,0,0.00) 0%, rgba(255,170,30,0.14) 18%, rgba(255,255,255,0.10) 50%, rgba(255,120,0,0.16) 82%, rgba(255,120,0,0.00) 100%);
              pointer-events: none;
            }}
            .vetted-badge .badge-icon {{
              ...
              height: 52px;
              flex: 0 0 48px;
              clip-path: polygon(50% 0%, 88% 12%, 88% 64%, 50% 100%, 12% 64%, 12% 12%);
              background: linear-gradient(180deg, #f0d37a 0%, #d4af37 52%, #9a6a12 100%);
              color: #111;
              font-weight: 900;
              font-size: 22px;
              line-height: 1;
              text-shadow: 0 1px 0 rgba(255,255,255,0.25);
              box-shadow: 0 0 0 2px rgba(17,17,17,0.35) inset, 0 0 14px rgba(212,175,55,0.25);
            }}
...
def format_contractor_card(contractor: dict):
    ...
    if approved:
        ...
        <div class="vetted-badge">
          ...
          <span class="badge-copy"><span class="badge-top">VaultForge</span><span class="badge-main">Vetted Contractor</span></span>
        </div>
        """
...
def homepage():
    ...
    <div class="card" style="margin-top:22px; text-align:center;">
      ...
      <h2 class="gold">What the Vetted Badge Means</h2>
      <p class="mini" style="max-width:760px; margin:0 auto 16px auto;">
      ...
      <div class="grid grid-3" style="margin-top:18px; text-align:left;">
        <div class="card">
          <h3>Verified business details</h3>
          <p class="mini">
            We review contractor business information before approval so homeowners are not browsing random unknown listings.
          </p>
        </div>
        <div class="card">
        ...
        <div class="card">
          <h3>Approved to receive homeowner requests</h3>
          <p class="mini">
            Only approved contractors show in the homeowner directory, and homeowners choose one vetted contractor instead of blasting requests everywhere.
          </p>
        </div>
      </div>
      <p class="mini" style="max-width:760px; margin:18px auto 0 auto; color:#f0d37a;">
        That badge is there to help homeowners feel safer choosing a contractor and to help good contractors stand out immediately.
      </p>
    </div>
    """
...
def contractor_dashboard(contractor_id: str, token: str = ""):
    ...
    <div class="hero premium-panel">
      ...
      {('<div class="vetted-badge subtle"><span class="badge-icon">✓</span><span class="badge-copy"><span class="badge-top">VaultForge</span><span class="badge-main">Vetted Contractor</span></span></div>' if contractor.get("approved") is True else '')}
