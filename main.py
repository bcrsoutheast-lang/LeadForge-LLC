...
def brand_html() -> str:
    ...
    <a class="brand-wrap" href="/">
      <img src="/static/vaultforge-logo.png" alt="VaultForge Logo" class="brand-logo" onerror="this.style.display='none'">
...
def admin_dashboard(request: Request):
    ...
    <div class="card" style="margin-top:20px;">
      ...
      <table>
        ...
        <tbody>
          {''.join(contractor_rows) if contractor_rows else '<tr><td colspan="12">No contractor applications found.</td></tr>'}
        </tbody>
      </table>
    </div>
