...
def request_success():
    ...
    <body>
        <div class="wrap">
            ...
            <p>The selected contractor can now be tied to this lead through their contractor ID.</p>
...
def admin():
    ...
    if leads:
        for l in leads:
            leads_html += f"""
            <div class="card">
                <div><strong>Homeowner:</strong> {l.get("owner_name", "")}</div>
                <div><strong>Phone:</strong> {l.get("phone", "")}</div>
                <div><strong>Service:</strong> {l.get("service", "")}</div>
                <div><strong>City:</strong> {l.get("city", "")}</div>
