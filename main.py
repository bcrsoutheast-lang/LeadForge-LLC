...
def contractor_signup():
    ...
    <body>
        <div class="wrap">
            ...
            <p class="sub">Contractor signup form restored. This step is still rebuild-safe and not connected to the database yet.</p>
            ...
            <div class="note">
                This form is still in safe rebuild mode. The disclaimer checkbox is now visible, but submit is intentionally inactive until we reconnect the backend carefully.
            </div>
...
def admin():
    ...
    <body>
        <div class="wrap">
            ...
            <p class="sub">Safe admin page restored. This is UI only for now and is not pulling live database records yet.</p>

            <div class="section">
                <h2>Pending Contractors</h2>

                <div class="card">
                    <div class="row"><strong>Business:</strong> Elite Roofing Co</div>
                    <div class="row"><strong>Contact:</strong> John Smith</div>
                    <div class="row"><strong>Email:</strong> john@example.com</div>
                    <div class="row"><strong>Phone:</strong> 205-555-1234</div>
                    <div class="row"><strong>Service:</strong> Roofing</div>
                    <div class="row"><strong>City:</strong> Birmingham</div>
                    <div class="status">Pending Review</div>
                    <div class="actions">
                        <a class="btn" href="#">Approve</a>
                        <a class="btn gray" href="#">Reject</a>
                    </div>
                </div>

                <div class="card">
                    <div class="row"><strong>Business:</strong> FreshWash Exterior</div>
                    <div class="row"><strong>Contact:</strong> Mike Taylor</div>
                    <div class="row"><strong>Email:</strong> mike@example.com</div>
                    <div class="row"><strong>Phone:</strong> 205-555-5678</div>
                    <div class="row"><strong>Service:</strong> Pressure Washing</div>
                    <div class="row"><strong>City:</strong> Hoover</div>
                    <div class="status">Pending Review</div>
                    <div class="actions">
                        <a class="btn" href="#">Approve</a>
                        <a class="btn gray" href="#">Reject</a>
            ...
            <div class="section">
                <h2>Recent Homeowner Requests</h2>

                <div class="card">
                    <div class="row"><strong>Homeowner:</strong> Sarah Johnson</div>
                    <div class="row"><strong>Service Needed:</strong> Roof Repair</div>
                    <div class="row"><strong>City:</strong> Birmingham</div>
                    <div class="row"><strong>Status:</strong> Demo Placeholder</div>
                </div>

                <div class="card">
                    <div class="row"><strong>Homeowner:</strong> David Brown</div>
                    <div class="row"><strong>Service Needed:</strong> Driveway Pressure Washing</div>
                    <div class="row"><strong>City:</strong> Hoover</div>
                    <div class="row"><strong>Status:</strong> Demo Placeholder</div>
                </div>
            </div>
            ...
            <div class="note">
                Admin layout is back. Approve and Reject buttons are visible, but not active yet. Database and action wiring come next after this page is confirmed stable.
            </div>
