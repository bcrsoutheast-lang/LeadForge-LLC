...
def homepage():
    body = """
    <div class="topbar">
      <a class="brand" href="/">LeadForge</a>
      <div class="nav">
    ...
    <div class="hero">
      <div class="hero-kicker gold"><strong>Exclusive homeowner opportunities. Cleaner matching. Less wasted time.</strong></div>
      <h1><span class="red">Choose Your Contractor.</span><br><span class="gold">Send One Request.</span></h1>
      <p class="hero-copy">
        LeadForge helps homeowners connect with approved contractors without spam, bidding wars,
        or getting blasted by five companies at once. Homeowners choose one contractor. Contractors
        get a real opportunity they can unlock for $10.
      </p>
      <div class="topnav">
    ...
    <div class="grid grid-2">
      <div class="card">
        ...
        <p class="mini">
          Browse by service, choose the contractor you want, and submit one direct project request.
          No lead reselling. No crowded inbox. No chasing down five companies at once.
        </p>
      ...
      <div class="card">
        ...
        <p class="mini">
          Apply to join LeadForge and receive exclusive homeowner requests. Review the request,
          then unlock full homeowner details for a flat $10 access fee.
        </p>
    ...
    <div class="card" style="margin-top:22px;">
      ...
      <div class="grid grid-3">
        <div class="card">
          ...
          <p class="mini">
            Roofing, siding, gutters, painting, flooring, plumbing, electrical, HVAC, landscaping,
            remodeling, and more.
          </p>
        </div>
        <div class="card">
          ...
          <p class="mini">
            The homeowner selects a specific approved contractor instead of blasting the same lead
            out to everyone in town.
          </p>
        </div>
        <div class="card">
          <h3>3. Contractor Unlocks the Opportunity</h3>
          <p class="mini">
            The contractor sees the request, then pays $10 to unlock full homeowner contact details
    ...
    <div class="grid grid-2" style="margin-top:22px;">
      <div class="card">
        ...
        <p class="mini">Start here if you need help with a project around the house.</p>
        <div class="topnav">
      ...
      <div class="card">
        <h2>Why Contractors Join</h2>
        <ul class="mini" style="padding-left:20px; margin:0;">
          <li>Free to apply</li>
          <li>Approved contractor directory</li>
          <li>Exclusive homeowner request flow</li>
          <li>Simple $10 unlock model</li>
          <li>No pay-per-click nonsense</li>
        </ul>
      </div>
    </div>

    <div class="card" style="margin-top:22px;">
      <h2>Built for cleaner matching</h2>
      <p class="mini">
        LeadForge is designed for a simpler experience on both sides: homeowners get a cleaner way
        to request the contractor they actually want, and contractors get better-quality opportunities
        without the normal marketplace chaos.
      </p>
      <div class="topnav">
        <a class="btn" href="/services">Find a Contractor</a>
...
def services():
    ...
    <div class="topbar">
      ...
      <div class="nav">
        ...
        <a class="btn secondary" href="/contractors">All Contractors</a>
        <a class="btn secondary" href="/join-contractor">Join as a Contractor</a>
      </div>
    </div>
