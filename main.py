...
def homeowner_page() -> str:
    ...
    <section class="card">
        ...
        <p>This plain homeowner page is now live as part of the stable rebuild.</p>
        <p>Next we can turn this into the real homeowner request form and contractor selection flow.</p>
...
def admin_page() -> HTMLResponse:
    ...
    <section class="card">
        <h1>LeadForge Admin</h1>
        <p class="muted">Stable rebuild step: homeowner entry route added and contractor disclaimer restored.</p>
