...
app = FastAPI(title="LeadForge Contractor Browse Rebuild")
...
def home() -> str:
    ...
    <section class="card">
        ...
        <p class="section-text">
            Contractor browse page is now the focus. Homeowner submit flow stays paused
            until we map the real leads schema exactly.
        </p>
    </section>
    """
...
def contractors_page() -> str:
    ...
    <section class="hero">
        <h1>Browse Contractors</h1>
        <p>
            Homeowners can review contractor profiles here first. Right now this shows
...
def homeowner_page() -> str:
    ...
    <section class="hero">
        <h1>Homeowner</h1>
        <p>
            Step 1 is now live: browse contractors. The homeowner request form will be
...
def admin_page() -> str:
    ...
    <section class="hero">
        <h1>LeadForge Admin</h1>
        <p>Admin stays live while the contractor browse page is rebuilt cleanly.</p>
        <div class="nav-row">
            <a class="btn btn-primary" href="/">Homepage</a>
            <a class="btn btn-primary" href="/contractors">Browse Contractors</a>
            <a class="btn btn-primary" href="/contractor-signup">Contractor Signup</a>
